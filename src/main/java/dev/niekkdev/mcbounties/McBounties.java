...
import dev.niekkdev.mcbounties.commands.GameCommands;
import dev.niekkdev.mcbounties.events.Events;

import dev.niekkdev.mcbounties.utils.Metrics;
import dev.niekkdev.mcbounties.utils.UpdateChecker;
...
public class McBounties extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (!this.isValidSpigotVersion()) {
            this.getLogger().warning("This plugin requires Minecraft 1.19.4 or higher");
            Bukkit.getPluginManager().disablePlugin(this);
            return;
        }
    ...
    private boolean isValidSpigotVersion() {
        ...
        return version.equals("v1_20_R1") || version.equals("v1_20_R2") || version.equals("v1_19_R3");
    }
